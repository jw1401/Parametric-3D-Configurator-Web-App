...
module.exports = function createJscadWorker (fullurl, script, callback)
{
  ...
  //var file = new File([blob],'async.js',{type: 'application/javascript'});

  var w = new Worker(blobURL); // here is the script put together by buildJscadWorkerScript
  //console.log(file);
  //var w = work(require(source));
...
function buildJscadWorkerScript(fullpath, fullscript)
{
  ...
  //source += 'module.exports = function (self){\n';
  //source += 'self.addEventListener(`message`,function (ev){\n'

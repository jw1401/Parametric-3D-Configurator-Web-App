...
//OpenJsCadViwer für interne Bezeichnung
var OpenJsCadViewer = function() { };

//Modulname für Zugriff
module.OpenJsCadViewer = OpenJsCadViewer;

//OpenJsCadViewer Constructor (Beinhaltenden containerElm, Size, options)
OpenJsCadViewer.Viewer = function(containerElm, size, options)
{
    // config stuff
    // fg and bg colors
...
OpenJsCadViewer.Viewer.prototype =
{
    // adds axes too

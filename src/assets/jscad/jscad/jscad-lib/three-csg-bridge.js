...
*/
    ...
    function fromCSG(csg, defaultColor)
    {
        ...
        polygons.forEach(function(polygon)
        {
            ...
            polyColor = polygon.shared.color ? polygon.shared.color.slice() : defaultColor.slice();
        ...
        var boundLen = three_geometry.boundingSphere.radius + three_geometry.boundingSphere.center.length() || 0;
...
module.exports = {fromCSG, getGeometryVertex};
